              ...
              m(
                ...
                m(
                  ...
                  m(
                    'label',
                    null,
                    app.translator.trans('flarum-suspend.forum.status.suspend_status')
                  ),
                  m(
                    'div',
                    null,
        ...
        extend(UserControls, 'moderationControls', function (items, user) {
          if (user.canSuspend()) {
            items.add('suspend', Button.component({
              children: app.translator.trans('flarum-suspend.forum.moderation_controls.suspend_button'),
              icon: 'ban',
        ...
        extend(User.prototype, 'badges', function (items) {
          ...
          if (new Date() < until) {
            items.add('suspended', Badge.component({
              icon: 'ban',
              type: 'suspended',
              label: app.translator.trans('flarum-suspend.forum.badge.suspended')
            }));
          }
        });
      });
